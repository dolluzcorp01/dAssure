-- =====================================================================
--  dAssure  Migration 016   Issuing by hand
--
...
--
--    email   dAssure sent it, and knows the address and the moment
...
--  supplier from my own mailbox" was to claim dAssure had sent it, which would
